...
import { getCachedContentIndex, normalizeFsPath } from "./content-index.js";
...
export const remarkWikilink: RemarkPluginFactory<RemarkWikiLinkPluginOptions> =
  ...
  (tree: Root, file: VFile) => {
    ...
    const index = getCachedContentIndex(docsRoot);
...
function shouldSkipParent(parent: Parent): boolean {
  return [
    "link",
    "linkReference",
    "definition",
